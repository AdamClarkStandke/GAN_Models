...
![alt text](https://github.com/aCStandke/GAN_Models/blob/main/1.jpg "Pierre Auguste Renoir, Portrait of Claude Monet")

![alt text](https://github.com/aCStandke/GAN_Models/blob/main/tekken_dude.jpeg "Ip Man")
  
These were the resulting images generated by the model after training:

![alt text](https://github.com/aCStandke/GAN_Models/blob/main/renior-image.png "Pierre Auguste Renoir, Portrait of Claude Monet")

![alt text](https://github.com/aCStandke/GAN_Models/blob/main/tekken-image.png "Ip Man")
